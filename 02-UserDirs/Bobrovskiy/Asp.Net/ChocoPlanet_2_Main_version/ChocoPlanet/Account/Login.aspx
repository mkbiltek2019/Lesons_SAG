<%@ Page Title="Log In" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="ChocoPlanet.Account.Login" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p> Будь-ласка введіть імя коритувача та пароль.
        
        <asp:HyperLink ID="RegisterHyperLink" 
                       runat="server" 
                       EnableViewState="false">Зареєструватися</asp:HyperLink> якщо ви не маєте акаунта.
    </p>
                ...
                <fieldset class="login">
                    ...
                    <p>
                        <asp:Label ID="UserNameLabel" runat="server" 
                                   AssociatedControlID="UserName">Імя користувача:</asp:Label>
                    ...
                    <p>
                        <asp:Label ID="PasswordLabel" runat="server" 
                                   AssociatedControlID="Password">Пароль:</asp:Label>
                    ...
                    <p>
                        ...
                        <asp:Label ID="RememberMeLabel" runat="server" 
                                   ...
                                   CssClass="inline">Залишатись в системі</asp:Label>
                    </p>
