...
namespace DataBaseForm.AdventureWorksLTDataSetTableAdapters {
...
SELECT CustomerID, NameStyle, Title, FirstName, MiddleName, LastName, Suffix, CompanyName, SalesPerson, EmailAddress, Phone, PasswordHash, PasswordSalt, rowguid, ModifiedDate, IsDeleted FROM SalesLT.Customer WHERE (CustomerID = SCOPE_IDENTITY())";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataBaseForm.Properties.Settings.Default.AdventureWorksLTConnectionString;
        }
