...
<head>
    ...
    <title>ChocoPlanet </title>

    <link  href="<?php echo base_url()?>styles/style.css" rel="stylesheet" type="text/css" media="screen" />
    <!--[if IE 6]><link rel="stylesheet" href="<?php echo base_url()?>styles/style.ie6.css" type="text/css" media="screen" /><![endif]-->
    <!--[if IE 7]><link rel="stylesheet" href="<?php echo base_url()?>styles/style.ie7.css" type="text/css" media="screen" /><![endif]-->
        ...
        <div class="art-sheet">
            ...
            <div class="art-sheet-body">
                <div class="art-header">
                    ...
                    <div class="art-logo">
                        <h1 id="name-text" class="art-logo-name"><a href="#">ChocoPlanet</a></h1>
                        <div id="slogan-text" class="art-logo-text">Планета шоколада</div>
                    </div>
                </div>
                <div class="art-nav">
                	<div class="l"></div>
                	...
                	<ul class="art-menu">
                		<li>
                			<a href="#" class="active"><span class="l"></span><span class="r"></span><span class="t">Главная</span></a>
                		</li>
                		<li>
                            ...
                            <div class="art-post-inner art-article">
                                            <div class="art-postmetadataheader">
                                                <h2 class="art-postheader">
                                                    <img src="<?php echo base_url();?>styles/images/postheadericon.png" width="300" height="200" alt="family" />
                                                    Продукция
                                                </h2>
                                            </div>
