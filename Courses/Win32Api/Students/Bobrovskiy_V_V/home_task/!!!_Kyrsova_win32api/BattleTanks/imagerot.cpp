...
HBITMAP aarot::dorotate(HBITMAP src, double rotation, int bgcolor, bool autoblend)
{
...
HBITMAP aarot::rotate(HBITMAP src, double rotation, int bgcolor, bool autoblend)
{
    ...
    HBITMAP res = dorotate(src, rotation, bgcolor, autoblend);
